...
{hapi_result_success,3713831785}
```
## Supported HAPI calls ( 54 / 135, 40% complete).
...
* **To further explain the license:**
  ...
  * **This clause forbids you from using this code in a GPL project and forbids you from re-licensing it under any of the GPL licenses afterwards.**
