...
bool
hapi_assetsubtype_erl_to_c(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_AssetSubType* enum_result)
{
...
ERL_NIF_TERM
hapi_assetsubtype_c_to_erl(ErlNifEnv* env, HAPI_AssetSubType enum_value)
{
    switch(enum_value)
    {
