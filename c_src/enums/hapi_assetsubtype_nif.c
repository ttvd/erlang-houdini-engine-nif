...
bool
hapi_make_hapi_assetsubtype_(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_AssetSubType* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_assetsubtype_c_to_erl(ErlNifEnv* env, HAPI_AssetSubType enum_value)
{
    switch(enum_value)
    {
