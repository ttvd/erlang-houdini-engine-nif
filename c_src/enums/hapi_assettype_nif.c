...
bool
hapi_make_hapi_assettype_(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_AssetType* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_assettype_c_to_erl(ErlNifEnv* env, HAPI_AssetType enum_value)
{
    switch(enum_value)
    {
