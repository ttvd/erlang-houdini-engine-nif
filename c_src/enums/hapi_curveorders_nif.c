...
bool
hapi_make_hapi_curveorders(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_CurveOrders* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_curveorders(ErlNifEnv* env, HAPI_CurveOrders enum_value)
{
    switch(enum_value)
    {
