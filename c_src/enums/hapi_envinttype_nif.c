...
bool
hapi_make_hapi_envinttype(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_EnvIntType* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_envinttype(ErlNifEnv* env, HAPI_EnvIntType enum_value)
{
    switch(enum_value)
    {
