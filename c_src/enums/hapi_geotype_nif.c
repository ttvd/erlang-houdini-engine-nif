...
bool
hapi_make_hapi_geotype_(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_GeoType* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_geotype_c_to_erl(ErlNifEnv* env, HAPI_GeoType enum_value)
{
    switch(enum_value)
    {
