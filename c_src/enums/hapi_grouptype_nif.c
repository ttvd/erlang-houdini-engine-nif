...
bool
hapi_grouptype_erl_to_c(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_GroupType* enum_result)
{
...
ERL_NIF_TERM
hapi_grouptype_c_to_erl(ErlNifEnv* env, HAPI_GroupType enum_value)
{
    switch(enum_value)
    {
