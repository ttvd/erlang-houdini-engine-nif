...
bool
hapi_make_hapi_imagedataformat(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_ImageDataFormat* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_imagedataformat(ErlNifEnv* env, HAPI_ImageDataFormat enum_value)
{
    switch(enum_value)
    {
