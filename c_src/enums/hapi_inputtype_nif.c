...
bool
hapi_make_hapi_inputtype_(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_InputType* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_inputtype_c_to_erl(ErlNifEnv* env, HAPI_InputType enum_value)
{
    switch(enum_value)
    {
