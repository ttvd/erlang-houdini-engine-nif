...
bool
hapi_make_hapi_permissions_(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_Permissions* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_permissions_c_to_erl(ErlNifEnv* env, HAPI_Permissions enum_value)
{
    switch(enum_value)
    {
