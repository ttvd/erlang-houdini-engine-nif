...
bool
hapi_make_hapi_presettype(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_PresetType* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_presettype(ErlNifEnv* env, HAPI_PresetType enum_value)
{
    switch(enum_value)
    {
