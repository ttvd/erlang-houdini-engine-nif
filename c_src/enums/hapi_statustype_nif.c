...
bool
hapi_statustype_erl_to_c(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_StatusType* enum_result)
{
...
ERL_NIF_TERM
hapi_statustype_c_to_erl(ErlNifEnv* env, HAPI_StatusType enum_value)
{
    switch(enum_value)
    {
