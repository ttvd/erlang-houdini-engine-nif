...
bool
hapi_make_hapi_statusverbosity_(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_StatusVerbosity* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_statusverbosity_c_to_erl(ErlNifEnv* env, HAPI_StatusVerbosity enum_value)
{
    switch(enum_value)
    {
