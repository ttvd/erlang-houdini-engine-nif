...
bool
hapi_make_hapi_storagetype(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_StorageType* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_storagetype(ErlNifEnv* env, HAPI_StorageType enum_value)
{
    switch(enum_value)
    {
