...
bool
hapi_make_hapi_transformcomponent(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_TransformComponent* enum_result)
{
...
ERL_NIF_TERM
hapi_get_hapi_transformcomponent(ErlNifEnv* env, HAPI_TransformComponent enum_value)
{
    switch(enum_value)
    {
