...
ERL_NIF_TERM
hapi_make_hapi_nodeinfo(ErlNifEnv* env, const HAPI_NodeInfo* hapi_struct)
{
    return enif_make_tuple(env, 12,
        hapi_make_atom(env, "hapi_nodeinfo"),
...
bool
hapi_get_hapi_nodeinfo(ErlNifEnv* env, const ERL_NIF_TERM term, HAPI_NodeInfo* hapi_struct)
{
    ...
    if(!enif_get_tuple(env, term, &tuple_size, &tuple_record) ||
        (tuple_size != 12) ||
        !hapi_check_atom(env, tuple_record[0], "hapi_nodeinfo", &atom_name_match) ||
        !atom_name_match ||
